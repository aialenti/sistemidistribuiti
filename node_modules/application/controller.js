...
data.from = "users"; //tabella dalla quale selezionare (non supporta join perché non necessari
data.where = [
  [
...
data.values = ["franco",country,escape("andrea.franco@gmail.com"),"password"];
